import { StyleSheet, Text, View, Modal, TouchableOpacity, TextInput, KeyboardAvoidingView } from 'react-native';
    ...
    return (
        ...
        >
            <View style={styles.modal}>
                ...
                >
                    <Text style={[styles.text,{padding:5,color:'#FFFFFF'}]}>Ready to Fight</Text>
                    <Sword />
                </TouchableOpacity>
            </View>
        </Modal>
